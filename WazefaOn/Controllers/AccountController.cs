    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                //case resultenum.LockedOut:
                //    return View("Lockout");
                //case resultenum.RequiresVerification:
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Employer")).ToList(),"Name","Name");
            return View();
        }
